...
void CJasonTopDown::SetFacing(int64_t _facing)
{
	facing = _facing;
}

CJasonTopDown::CJasonTopDown(int64_t _facing, int64_t _pace)
{
	facing = _facing;
	pace = _pace;
...
void CJasonTopDown::Update(DWORD dt)
{
	...
	int64_t hKey = keyRight - keyLeft;
	int64_t vKey = keyDown - keyUp;
...
void CJasonTopDown::GetSetAnimation(DWORD dt, int64_t _facing, int64_t _pace)
{
	switch (_facing)
	{
	case LEFT:
