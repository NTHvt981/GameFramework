...
void CDynamicBox::CalculateCollision(Vector& velocity, std::list<CollisionEvent>& events)
{
...
{
	for (LPCollisionBox& oldBoxes : coCollisionBoxes)
	{
	...
	for (const LPCollisionBox& newBox : coCollisionBoxes)
	{
