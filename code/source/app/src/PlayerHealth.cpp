...
void CPlayerHealth::ReduceSophiaHealth(int64_t damage)
{
...
void CPlayerHealth::IncreaseSophiaHealth(int64_t heal_points)
{
...
void CPlayerHealth::ReduceJasonHealth(int64_t damage)
{
...
void CPlayerHealth::IncreaseJasonHealth(int64_t heal_points)
{
...
void CPlayerHealth::ReduceHealth(GOTYPES Type, int64_t damage)
{
...
void CPlayerHealth::ReduceHealth(int64_t damage)
{
...
void CPlayerHealth::IncreaseHealth(GOTYPES Type, int64_t heal_points)
{
    if (Type == GOTYPES::Jason)
...
void CPlayerHealth::IncreaseHealth(int64_t heal_points)
{
    if (playerMode == SOPHIA)
        IncreaseSophiaHealth(heal_points);
    else if (playerMode == JASON)
...
void CPlayerHealth::SetPlayerMode(int64_t _mode)
{
    playerMode = _mode;
}

int64_t CPlayerHealth::GetHealthState()
{
    return healthState;
}
...
void CPlayerHealth::Render()
{
    ...
    int64_t count = 0;
    int64_t healthBarHeight, healthBarWidth;
