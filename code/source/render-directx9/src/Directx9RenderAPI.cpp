...
Directx9RenderAPI::Directx9RenderAPI(const HWND i_hwnd)
	: m_hwnd(i_hwnd)
{
}

Directx9RenderAPI::~Directx9RenderAPI()
{
	Shutdown();
}

void Directx9RenderAPI::Initialize()
{
	if (s_initFlag.IsSet())
	{
		return;
...
void Directx9RenderAPI::LoadTexture(
...
void Directx9RenderAPI::Draw(const DrawParams& i_drawParams)
{
...
LPDIRECT3DTEXTURE9 Directx9RenderAPI::CreateTextureFromFile(const core::String& imagePath)
{
	D3DXIMAGE_INFO info;
...
void Directx9RenderAPI::Shutdown()
{
...
ids::APIMode Directx9RenderAPI::GetAPIMode() const
{
