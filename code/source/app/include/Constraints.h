...
#define ENEMIES_TEXTURE_PATH L"Texture\\enemies.png"
#define PLAYER_TEXTURE_PATH L"Texture\\PlayerSheetTransparent.png"
#define PLAYER_HEALTH_TEXTURE_PATH L"Texture\\Player health.png"
#define OTHER_OBJECTS_TEXTURE_PATH L"Texture\\OtherObjects.png"
#define BLACK_SCREEN_TEXTURE_PATH L"Texture\\BlackScreen.png"
#define BOSS_TEXTURE_PATH L"Texture\\Boss.png"
...
#define INTRO_TO_SIDESCROLL_POS Vector(50, 2940)
...
#define START_AREA2_SIDESCROLL_POS Vector(72 * 16, 184 * 16)
#define START_AREA3_SIDESCROLL_POS Vector(102 * 16, 120 * 16)
#define START_AREA4_SIDESCROLL_POS Vector(136 * 16, 120 * 16)
#define START_AREA5_SIDESCROLL_POS Vector(120 * 16, 72 * 16)
#define START_AREA6_SIDESCROLL_POS Vector(133 * 16, 8 * 16)
#define START_AREA7_SIDESCROLL_POS Vector(167 * 16, 9 * 16)
#define START_AREA8_SIDESCROLL_POS Vector(150 * 16, 26 * 16)
#define START_AREA9_SIDESCROLL_POS Vector(90 * 16, 72 * 16)

#define START_AREA2_TOPDOWN_POS Vector(10 * 32, 60 * 32)
#define START_AREA3_TOPDOWN_POS Vector(18 * 32, 60 * 32)
#define START_AREA4_TOPDOWN_POS Vector(20 * 32, 53 * 32)
#define START_AREA5_TOPDOWN_POS Vector(20 * 32, 45 * 32)
#define START_AREA6_TOPDOWN_POS Vector(14 * 32, 44 * 32)
#define START_AREA7_TOPDOWN_POS Vector(12 * 32, 37 * 32)
#define START_AREA8_TOPDOWN_POS Vector(6 * 32, 36 * 32)
#define START_AREA9_TOPDOWN_POS Vector(4 * 32, 29 * 32)
#define START_AREA10_TOPDOWN_POS Vector(10 * 32, 28 * 32)
#define START_AREA11_TOPDOWN_POS Vector(18 * 32, 28 * 32)