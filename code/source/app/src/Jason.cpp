...
void CJason::SetFacing(int64_t _facing)
{
	facing = _facing;
}

CJason::CJason(int64_t _state, int64_t _facing, int64_t _pace) : CPlayer()
{
	gravity = 0.2;
	jumpSpeed = 3;
...
{
	CInput* input = CInput::GetInstance();
	int64_t moveKey = input->IsKeyDown(DIK_D) - input->IsKeyDown(DIK_A);
